"""
aborted attempt to shove particles into sql for better querying.
with existing temp data for the 2014 period, not that interesting.
...
# Any SCWA data we can use?
#   BSPP has cond, pH, turb, watertemp.
