...
##
r18=dfm_grid.DFMGrid('../bathy/grid-sources/r18b_net.nc')

r17=dfm_grid.DFMGrid('../bathy/grid-sources/cascade/r17b_net.nc')
...
# for the purpose of grid generation, extract shoreline poly from the schism
# grid.
